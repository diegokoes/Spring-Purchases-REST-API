 ...
 * En una aplicación web, cada petición HTTP pasa por una cadena de filtros (filter chain) antes de llegar al
 * controlador que realmente atiende la solicitud.
...
public class JwtFilter extends OncePerRequestFilter {
    ...
    protected void doFilterInternal(HttpServletRequest request,
        ...
        // Authorization: Bearer asdfaksdjflaksjdflaks jdfaksjdflasdf.asldkfjasñldkfjaslkdfjalksdf
